...
export default function SubcategoryPage() {
  const [match, params] = useRoute(
    "/products/:mainCategorySlug/:subcategorySlug"
  );

  if (!match) return <NotFound />;

  const result = findSubcategory(
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="bg-secondary text-secondary-foreground py-16 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-3xl font-light leading-relaxed whitespace-pre-line">
      ...
      <section className="py-16 bg-background">
        <div className="container">
          {subcategory.slug === "wastewater-submersible-pumps" ||
            ...
            <div className="relative min-h-[60vh] flex flex-col items-center justify-center overflow-hidden border border-border bg-white">
              ...
              <div className="relative z-10 text-center px-4 max-w-3xl">
                ...
                <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
                  Our engineering team is currently finalizing the technical
                  specifications for this product line. Please check back
                  shortly for full catalogs and performance curves.
                </p>

                <div className="mt-10">
                  <Link href={`/products/${mainCategory.slug}`}>
                    <a className="inline-flex items-center gap-2 text-primary font-bold uppercase tracking-wider hover:underline">
                      <ChevronRight className="w-4 h-4 rotate-180" /> Back to{" "}
                      {mainCategory.name}
                    </a>
                  </Link>
                </div>
