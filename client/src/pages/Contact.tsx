      ...
      <section className="py-20 bg-background">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-heading font-bold mb-8 text-foreground">{t('contact.formTitle')}</h2>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-sm font-bold uppercase tracking-wide text-muted-foreground">{t('contact.name')}</label>
                    <Input 
                      id="name" 
                      {...register('name')} 
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-bold uppercase tracking-wide text-muted-foreground">{t('contact.email')}</label>
                    <Input 
                      id="email" 
                      type="email"
                      {...register('email')} 
                ...
                <div className="space-y-2">
                  <label htmlFor="company" className="text-sm font-bold uppercase tracking-wide text-muted-foreground">{t('contact.company')}</label>
                  <Input 
                    id="company" 
                    {...register('company')} 
                    className="bg-white border-border h-12 rounded-none focus:ring-primary"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-bold uppercase tracking-wide text-muted-foreground">{t('contact.message')}</label>
                  <Textarea 
                    id="message" 
                    {...register('message')} 
            ...
            <div className="space-y-8">
              <div className="bg-muted/30 p-8 border border-border">
                <h3 className="text-xl font-heading font-bold mb-6 text-foreground">{t('contact.infoTitle')}</h3>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-foreground mb-1">{t('contact.headquarters')}</h4>
