...
export default function Contact() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    // Fallback to mailto
    window.location.href = `mailto:waterpumps@mmbgermany.com?subject=Inquiry from ${data.name}&body=${encodeURIComponent(data.message)}`;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="bg-muted/30 p-8 border border-border">
                <h3 className="text-xl font-heading font-bold mb-6 text-foreground">
                  {t("contact.infoTitle")}
                </h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:waterpumps@mmbgermany.com"
