              ...
              <Link key={subcategory.slug} href={`/products/${mainCategory.slug}/${subcategory.slug}`}>
                <a className="group block h-full">
                  <div className="tech-card h-full flex flex-col bg-white border border-border hover:border-primary transition-all duration-300 hover:shadow-lg">
                    {/* Image Area */}
                    <div className="relative h-48 p-8 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center overflow-hidden border-b border-border">
                      {subcategory.comingSoon ? (
                        ...
                        <>
                          <img 
                            ...
                            className="w-auto h-full max-h-32 object-contain transition-transform duration-500 group-hover:scale-110"
                          />
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto pt-4 border-t border-border/50 flex justify-between items-center">
                        <span className="text-xs font-bold uppercase tracking-wider text-foreground">
                          {subcategory.comingSoon ? 'Coming Soon' : 'View Products'}
                        </span>
                        {!subcategory.comingSoon && (
